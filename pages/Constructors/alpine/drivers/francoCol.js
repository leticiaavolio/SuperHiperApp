...
export default function FrancoCol({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Franco Colapinto</Text>
                <Image source={require("../../../../assets/imgs/franco.jpg")} style={styles.img}/>
