...
export default function PierreGas({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Pierre Gasly</Text>
                <Image source={require("../../../../assets/imgs/pierre.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 10;{'\n'}
                Nacionalidade: Francês;{'\n'}
                Idade: 29;{'\n'}
                Ano de Estreia: 2017;{'\n'}
                Equipe Atual: Alpine;{'\n'}
                Histórico de Equipes: Toro Rosso, RedBull, AlphaTauri;{'\n'}
                Nº de Vitórias: 1;{'\n'}
                Nº de Títulos: 0;{'\n'}
                Pontos: 7.{'\n'}</Text>
            </View>
