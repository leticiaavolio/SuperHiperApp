...
export default function GabrielBor({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Gabriel Bortoleto</Text>
                <Image source={require("../../../../assets/imgs/gabriel.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 05;{'\n'}
