...
export default function FernandoAlo({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Fernando Alonso</Text>
                <Image source={require("../../../../assets/imgs/fernando.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 43;{'\n'}
                Nacionalidade: Espanhol;{'\n'}
                Idade: 43;{'\n'}
                Ano de Estreia: 2001;{'\n'}
                Equipe Atual: Aston Martin;{'\n'}
                Histórico de Equipes: Minardi, Renault, Mclaren, Ferrari, Alpine;{'\n'}
                Nº de Vitórias: 32;{'\n'}
                Nº de Títulos: 2;{'\n'}
                Pontos: 0.{'\n'}</Text>
            </View>
