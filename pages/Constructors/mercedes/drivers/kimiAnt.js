...
export default function KimiAnt({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}> Andrea Kimi Antonelli</Text>
                <Image source={require("../../../../assets/imgs/kimi.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 12;{'\n'}
