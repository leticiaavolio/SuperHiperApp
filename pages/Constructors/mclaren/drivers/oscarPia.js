...
export default function OscarPia({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Oscar Piastri</Text>
                <Image source={require("../../../../assets/imgs/oscar.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 81;{'\n'}
