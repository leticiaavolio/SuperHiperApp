...
export default function CarlosSai({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Carlos Sainz</Text>
                <Image source={require("../../../../assets/imgs/carlos.webp")} style={styles.img}/>
                <Text style={styles.para}>Número: 55;{'\n'}
