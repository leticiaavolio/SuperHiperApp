...
export default function LiamLaw({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Liam Lawson</Text>
                <Image source={require("../../../../assets/imgs/liam.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 30;{'\n'}
                Nacionalidade: Neozelandes;{'\n'}
                Idade: 23;{'\n'}
                Ano de Estreia: 2023;{'\n'}
                Equipe Atual: RacingBulls;{'\n'}
                Histórico de Equipes: RacingBulls, RedBull;{'\n'}
                Nº de Vitórias: 0;{'\n'}
                Nº de Títulos: 0;{'\n'}
                Pontos: 0.{'\n'}</Text>
            </View>
