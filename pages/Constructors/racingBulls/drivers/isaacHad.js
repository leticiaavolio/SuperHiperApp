...
export default function IsackHad({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Isack Hadjar</Text>
                <Image source={require("../../../../assets/imgs/isack.webp")} style={styles.img}/>
                <Text style={styles.para}>Número: 06;{'\n'}
