...
export default function MaxVer({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Max Verstappen</Text>
                <Image source={require("../../../../assets/imgs/max.webp")} style={styles.img}/>
                <Text style={styles.para}>Número: 01;{'\n'}
                Nacionalidade: Holandês;{'\n'}
                Idade: 27;{'\n'}
                Ano de Estreia: 2015;{'\n'}
                Equipe Atual: RedBull;{'\n'}
