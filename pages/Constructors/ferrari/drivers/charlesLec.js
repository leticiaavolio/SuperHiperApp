...
export default function CharlesLec({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Charles Leclerc</Text>
                <Image source={require("../../../../assets/imgs/charles.jpg")} style={styles.img}/>
                <Text style={styles.para}>Número: 16;{'\n'}
                Nacionalidade: Monegasco;{'\n'}
                Idade: 27;{'\n'}
                Ano de Estreia: 2018;{'\n'}
                Equipe Atual: Ferrari;{'\n'}
                Histórico de Equipes: Alpha Romeo;{'\n'}
                Nº de Vitórias: 8;{'\n'}
                Nº de Títulos: 0;{'\n'}
                Pontos: 53.{'\n'}</Text>
            </View>
