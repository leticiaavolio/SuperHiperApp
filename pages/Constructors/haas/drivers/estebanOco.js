...
export default function EstebanOco({navigation}) {
    ...
    <ScrollView>
        <View style={styles.container}></View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.titleP}>Esteban Ocon</Text>
                <Image source={require("../../../../assets/imgs/esteban.jpeg")} style={styles.img}/>
                <Text style={styles.para}>Número: 31;{'\n'}
                Nacionalidade: Francês;{'\n'}
                Idade: 28;{'\n'}
                Ano de Estreia: 2016;{'\n'}
                Equipe Atual: Haas;{'\n'}
                Histórico de Equipes: Manor, Force India, Renault, Alpine;{'\n'}
                Nº de Vitórias: 1;{'\n'}
                Nº de Títulos: 0;{'\n'}
                Pontos: 14.{'\n'}</Text>
            </View>
